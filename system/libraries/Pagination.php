...
class CI_Pagination {
	...
	var $first_link			= '<i class="icon-double-angle-left"></i> Đầu';
	var $next_link			= 'Sau <i class="icon-long-arrow-right"></i>';
	var $prev_link			= '<i class="icon-long-arrow-left"></i> Trước';
	var $last_link			= 'Cuối <i class="icon-double-angle-right"></i>';
	var $uri_segment		= 3;
