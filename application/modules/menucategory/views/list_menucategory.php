        ...
        <div id="page-content">
            <div id='wrap'>
                ...
                <div class="container">
                	...
                	<form action="<?php echo site_url("menucategory/index");?>" method="post" name="form" id="form">
                        ...
                        <div class="panel-body collapse in">
                            ...
                            <div class="row">
                                <div class="col-xs-6">                            
                                    <div id="example_length" class="dataTables_length">
                                        <label>
                                            <select size="1" name="menucategory_records_per_page" id="menucategory_records_per_page" aria-controls="example" class="form-control records_per_page">
                            	...
                            	<div class="col-xs-6">
                                	<div class="dataTables_filter" id="example_filter">
                                    	...
                                    	<label>
                                        	<input type="text" aria-controls="example" class="form-control search" placeholder="Search..." name="menucategory_search" value="<?php echo $search;?>">
                                        </label>
                                    </div>
                                </div>
                            </div>                            
                            ...
                            <table class="table">
                                    <thead>
                                        <tr>
                                        	<!--SORT-->
                                            <input type="hidden" name="menucategory_order_by"  id="order_by" value="<?php echo $order_by; ?>" />
                                            <input type="hidden" name="menucategory_asc_desc" id="asc_desc" value="<?php echo $asc_desc; ?>" />
                                        	<!--SORT-->
                                            ...
                                            <th width="10%" class="sort <?php echo ($order_by == 'link') ? 'sorting_'.$asc_desc : '';?>"
                                            				title="Click to sort" alt="link">Link</th>
                                                            
                                            <th width="10%" class="sort <?php echo ($order_by == 'ordered') ? 'sorting_'.$asc_desc : '';?>"
                                            				title="Click to sort" alt="ordered">Ordered</th>
                                                            
                                            <th width="10%" class="sort <?php echo ($order_by == 'published') ? 'sorting_'.$asc_desc : '';?>"
                                    ...
                                    <tbody class="selects">                                        
                                        <?php
                                            ...
                                            foreach($info as $item){
												...
												if($canEdit)
	                                                echo "<td><a href='".base_url()."index.php/menucategory/edit_menucategory/$item[id]'>$item[title]</a></td>";
												else
												...
												if($canEdit){
													$publishedLink = "<a style='color: #fff; text-decoration: none;' 																href='".base_url()."index.php/menucategory/unpublished_menucategory/$item[id]'>Published</a>";
													$unpublishedLink = "<a style='color: #fff; text-decoration: none;' 																href='".base_url()."index.php/menucategory/published_menucategory/$item[id]'>Unpublished</a>";
												}else{
												...
												if($canEdit)
                                                	echo "<td align='center'><a href='".base_url()."index.php/menucategory/edit_menucategory/$item[id]'><i class='icon-wrench'></i></a></td>";
                                                else
													echo "<td align='center'><i class='icon-wrench'></i></td>";
													
												if($canEdit)
                                                	echo "<td align='center'><a href='".base_url()."index.php/menucategory/delete_menucategory/$item[id]'><i class='icon-trash'></i></a></td>";
                                                else
                    ...
                    <script language="javascript">
						$(document).ready(function(){								
							$("#menucategory_records_per_page").on("change", function(){
								$("#form").submit();
							});	
							...
							$("#delete_button").on("click", function(){
								...
								if (r == true) {									
									$("#form").attr("action", '<?php echo site_url("menucategory/delete_menucategory");?>');
									$("#form").submit();
								}
							});	
														
							$("#new_button").on("click", function(){								
								$("#form").attr("action", '<?php echo site_url("menucategory/new_menucategory");?>');
								$("#form").submit();
							});	
