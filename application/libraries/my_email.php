...
class MY_Email extends CI_Email {
     ...
     function config($data){
        $this->_mail=array(
                            "from_sender"       => "long111222333444@gmail.com",
                            "name_sender"       => "Yes4All.com", 
                            "subject_sender"    => "Reset password",
                         );
     ...
     function sendmail(){
            ...
            $config['smtp_user']    = 'long111222333444@gmail.com'; // địa chỉ gmail
            $config['smtp_pass']    = 'Long123456'; // pass gmail
