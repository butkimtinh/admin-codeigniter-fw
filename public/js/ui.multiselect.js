...
(function($) {
    ...
    $.widget("ui.multiselect", {
        ...
        _create: function() {
            ...
            this.container.width(601);
            this.selectedContainer.width(300);
            this.availableContainer.width(300);

            // fix list height to match <option> depending on their individual header's heights
            this.selectedList.height(Math.max(this.element.height()-this.selectedActions.height(),1)+100);
            this.availableList.height(Math.max(this.element.height()-this.availableActions.height(),1)+100);
